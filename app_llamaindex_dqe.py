...
import utils_llamaindex_dqe
import os
from dotenv import load_dotenv
from llama_index.embeddings.openai import OpenAIEmbedding
from utils_llamaindex_dqe import build_direct_query_index, get_direct_query_engine
...
async def get_response(query: str, company: str):
    ...
    query_engine = get_direct_query_engine(pc, index_name)
...
async def create_index(index: str):
    ...
    build_direct_query_index(pc, document, llm, embeddings, index_name)
    return "Success"
